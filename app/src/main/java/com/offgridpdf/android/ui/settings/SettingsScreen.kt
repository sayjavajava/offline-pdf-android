...
fun SettingsScreen() {
    ...
    Column(modifier = Modifier.fillMaxSize().background(palette.paper)) {
        ...
        // Bottom inset in contentPadding so the last setting clears the
        // gesture pill; horizontal for a landscape cutout. The top is already
        // handled by ScreenTopBar above.
